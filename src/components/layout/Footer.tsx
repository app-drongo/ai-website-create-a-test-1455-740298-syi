          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                user experiences. Join thousands of businesses who trust our comprehensive platform
                for their growth.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">contact@testwebsite.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive exclusive insights and industry updates. Unsubscribe at any time.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Crafted with <Heart className="size-3 text-red-500 fill-current" /> by our dedicated
                team
              </span>
            </div>
