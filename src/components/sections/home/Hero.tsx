...
export default function Hero({
  badge = 'Beta: Next-Gen Platform',
  title = 'Build powerful applications with',
  titleHighlight = 'Test Website Platform',
  description = 'Experience cutting-edge development tools designed for modern tech teams. Deploy faster, scale smarter, and innovate without limits.',
  features = [
  ...
  imageAlt = 'Advanced dashboard interface',
